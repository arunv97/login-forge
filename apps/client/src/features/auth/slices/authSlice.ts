...
const initialState: AuthState = {
  user: null,
  token: null, // Will be loaded from localStorage by loadUserFromStorage
  refreshToken: null, // Will be loaded from localStorage
...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    setRefreshedTokens: (
      ...
      state.isAuthenticated = true; // User is still authenticated
    },
    logout: (state) => {
      state.user = null;
      state.token = null;
